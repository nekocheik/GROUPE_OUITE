...
export default {
  ...
  mounted() {
    ...
    var germanyPoint = placePoint( 'germanyPoint', 52.520007, 13.404954 , ()=>{
        this.callPopup(5);
    });

    //RAYCASTER + DRAG MOUSEMOVE
    //Table for raycasting the points
    var points = [egyptPoint, chinaPoint, englandPoint, americaPoint, germanyPoint, earth];
    var pickedObject;
